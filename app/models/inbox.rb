...
class Inbox < ApplicationRecord
  ...
  after_create_commit :setup_channel_webhooks
  ...
  def setup_channel_webhooks
    # Trigger webhook setup for channels that need inbox_id (like Wuzapi)
    channel.setup_webhooks if channel.respond_to?(:setup_webhooks)
  end
end
